...
\usepackage{url}
\usepackage{booktabs}
\title{Robot Skill Half-Life Under Shift: ICLR Main-Conference Gate Archive}
\author{Anonymous Authors}
\begin{document}
\maketitle
\begin{abstract}
This document is not an ICLR main-conference submission. It is the v3 main-conference gate for a generated robotics draft about continual robot learning. The original research bet was: Quantify how quickly skills decay under small physical environment shifts. After a stricter hostile review, the honest terminal decision is \textbf{KILL/ARCHIVE}. Submission-hardening version: v3.
\end{abstract}
...
\begin{itemize}
\item Planning under Distribution Shifts with Causal POMDPs (2026)
...
\item Lost in translation? Skills policy and the shift to skill ecosystems (2012)
\item Learning and transfer of complex motor skills in virtual reality: a perspective review (2019)
\item Transformative top-down planning in a small African city: How residents in Bagamoyo, Tanzania connect with a city in motion (2021)
\end{itemize}
